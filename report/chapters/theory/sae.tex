...
Their experiments (see section \ref{sec:evaluation}) on GPT-4 \parencite{openai_gpt-4_2024} show that the TopK activation function performs best overall.
...
This is mentioned in many of the papers, especially those mentioned in section \ref{sec:evaluation}, that luckily are taking steps to resolve this issue.
