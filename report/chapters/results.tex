In this chapter we present the results of our experiments, starting with
an investigation of the performance of \ac{N2G} on the two populations of features: \ac{MLP} neurons and \ac{SAE} latents.
...
Finally, the relationship between geometry of the features and the clusters is investigated.
