...
We start by investigating the performance of \ac{N2G} on the two populations of features: \ac{MLP} neurons and \ac{SAE} latents.
We then look at the relationship between feature \ac{N2G} performance and density.
\todo{Introduce clusters}
...
In the following, we look at two sets of features: \ac{MLP} neurons and \ac{SAE} latents.
...
We start by looking at the performance of the \ac{N2G} models across the two populations: \ac{MLP} neurons and \ac{SAE} latents.
