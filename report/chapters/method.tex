...
The implementation used for these experiments is available at \todo{path to python file}.
For the results below, we used $\alpha=1$, $c=0.5$, and $n=32$.

\section{N2G}
Our code for training and evaluating N2G models is heavily based on the original implementation \todo{cite code not article}.
