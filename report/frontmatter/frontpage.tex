...
\node[anchor=north west, 
     ...
     {\includegraphics[width=14.75mm,keepaspectratio]{images/logos/\dtulogocolour_\targetcolourmodel.pdf}}; 
\end{tikzpicture}
...
\node[anchor=south, % anchor is bottom of picture
     ...
     {\includegraphics[height=18.9cm,keepaspectratio]{images/DTU_stock_photo.jpg}};
\end{tikzpicture}
